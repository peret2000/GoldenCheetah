...
GcWindowRegistry::initialize()
{
  static GcWindowRegistry GcWindowsInit[] = {
    ...
    //{ VIEW_TRENDS|VIEW_PLAN,  tr("Performance Manager"),GcWindowTypes::PerformanceManager },
    ...
    //{ VIEW_TRENDS|VIEW_PLAN, tr("Calendar"),GcWindowTypes::Diary },
    { VIEW_TRENDS|VIEW_PLAN, tr("Navigator"), GcWindowTypes::ActivityNavigator },
    //{ VIEW_PLAN|VIEW_TRENDS, tr("Summary "), GcWindowTypes::DateRangeSummary }, // DEPRECATED IN V3.6
