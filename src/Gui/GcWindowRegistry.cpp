...
GcWindowRegistry::initialize()
{
  static GcWindowRegistry GcWindowsInit[] = {
    ...
    { GcViewType::VIEW_TRAIN, tr("Geolocation Chart"),GcWindowTypes::GeoLocationChart },
    { GcViewType::VIEW_TRAIN, tr("Live Map"),GcWindowTypes::LiveMapWebPageWindow },
    { GcViewType::VIEW_TRAIN, tr("HTML Training Chart"),GcWindowTypes::HtmlTraining },
    { GcViewType::VIEW_ANALYSIS, tr("HTML Activities Chart"),GcWindowTypes::HtmlActivities },
    { GcViewType::VIEW_TRAIN, tr("Elevation Chart"),GcWindowTypes::ElevationChart },
    { GcViewType::VIEW_ANALYSIS|GcViewType::VIEW_TRENDS|GcViewType::VIEW_PLAN|GcViewType::VIEW_TRAIN, tr("Web page"),GcWindowTypes::WebPageWindow },
